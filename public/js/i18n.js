...
const translations = {
    ...
    'nav.my_orders': { id: 'Riwayat Pesanan', en: 'Order History' },
    'nav.user_dashboard': { id: 'Dashboard', en: 'Dashboard' },
    ...
    'profile.photo_editor': { id: '📷 Editor Foto Profil', en: '📷 Profile Photo Editor' },
    'profile.crop_cancel': { id: 'Batal', en: 'Cancel' },
    'profile.crop_apply': { id: 'Terapkan Crop', en: 'Apply Crop' },
    'profile.crop_result': { id: '✅ Hasil Crop:', en: '✅ Crop Result:' },
    'profile.crop_reset': { id: 'Batalkan Ubahan', en: 'Reset Changes' },
    ...
    'profile.phone_placeholder': { id: 'Contoh: 081234...', en: 'Example: 081234...' },
    'profile.address_placeholder_seller': { id: 'Alamat domisili pribadi Anda untuk belanja (Beda dari alamat Toko)', en: 'Your personal address for shopping (Different from Store address)' },
    'profile.address_placeholder_customer': { id: 'Alamat rumah untuk penerimaan paket belanja Anda', en: 'Home address for receiving your shopping packages' },
    'profile.bank_placeholder': { id: 'Contoh: BCA 1234567890 a.n Anda', en: 'Example: BCA 1234567890 a/n Your Name' },
    'profile.new_password_placeholder': { id: 'Masukan sandi baru', en: 'Enter new password' },
    'profile.confirm_password_placeholder': { id: 'Ulangi sandi baru', en: 'Re-enter new password' },
    ...
    'settings.desc_placeholder': { id: 'Contoh: Apotek Tepercaya Melayani 24 Jam', en: 'Example: Trusted Pharmacy Serving 24 Hours' },
    'settings.address_placeholder': { id: 'Jalan Raya No.123, Blok A, Kota X - Info Domisili Paket Keluar', en: 'Main Street No.123, Block A, City X - Outgoing Package Address' },
    'settings.save_btn': { id: '💾 Simpan Perubahan Publik', en: '💾 Save Public Changes' },
    'settings.banner_editor': { id: '✂️ Editor Banner', en: '✂️ Banner Editor' },
    'settings.crop_cancel': { id: 'Batal', en: 'Cancel' },
    'settings.crop_apply': { id: 'Terapkan Crop', en: 'Apply Crop' },
    'settings.crop_result': { id: '✅ Hasil Crop Banner:', en: '✅ Banner Crop Result:' },
    'settings.crop_reset': { id: 'Batalkan Ubahan', en: 'Reset Changes' },
    ...
    // ========== USER DASHBOARD ==========
    'user.dashboard_title': { id: 'Dashboard Saya', en: 'My Dashboard' },
    ...
    'user.recent_orders': { id: 'Pesanan Terbaru', en: 'Recent Orders' },
    'user.view_all_orders': { id: '📦 Lihat Semua Pesanan', en: '📦 View All Orders' },
    'user.items_count': { id: 'Item:', en: 'Items:' },
    'user.see_full_history': { id: 'Lihat Riwayat Lengkap →', en: 'View Full History →' },
    'user.all_orders': { id: 'Semua Pesanan', en: 'All Orders' },
    'user.order_history_desc': { id: 'Kelola riwayat dan status pesanan Anda.', en: 'Manage your order history and statuses.' },
    ...
    'user.no_items': { id: 'Tidak ada item', en: 'No items' },
    ...
    'chat.inbox_title': { id: '💬 Pesan', en: '💬 Messages' },
    'chat.unread': { id: 'belum dibaca', en: 'unread' },
    'chat.no_conversations': { id: 'Belum ada percakapan', en: 'No conversations yet' },
    'chat.no_conversations_desc': { id: 'Mulai chat dengan penjual dari halaman produk!', en: 'Start chatting with sellers from product pages!' },
    'chat.typing': { id: 'sedang mengetik...', en: 'typing...' },
    'chat.product_context': { id: '📦 Produk yang dibahas', en: '📦 Product discussed' },
    'chat.order_context': { id: '📋 Pesanan terkait', en: '📋 Related order' },
    'chat.view_product': { id: 'Lihat →', en: 'View →' },
    'chat.view_order': { id: 'Detail →', en: 'Detail →' },
    'chat.start_conversation': { id: 'Mulai percakapan!', en: 'Start a conversation!' },
    'chat.start_conversation_desc': { id: 'Kirim pesan untuk memulai obrolan.', en: 'Send a message to start chatting.' },
    'chat.type_message': { id: 'Ketik pesan...', en: 'Type a message...' },
    ...
    'chat.chip_nett_msg': { id: 'Halo, berapa harga nett untuk produk ini?', en: 'Hi, what\'s the nett price for this product?' },
    'chat.chip_discount': { id: '🏷️ Ada diskon?', en: '🏷️ Any discount?' },
    'chat.chip_discount_msg': { id: 'Halo, apakah ada diskon untuk pembelian lebih dari satu?', en: 'Hi, is there a discount for buying more than one?' },
    'chat.chip_usage': { id: '📋 Cara pemakaian?', en: '📋 How to use?' },
    'chat.chip_usage_msg': { id: 'Halo, bagaimana cara pemakaian produk ini?', en: 'Hi, how do I use this product?' },
    'chat.chip_shipping': { id: '🚚 Lama pengiriman?', en: '🚚 Shipping time?' },
    'chat.chip_shipping_msg': { id: 'Halo, berapa lama pengiriman untuk produk ini?', en: 'Hi, how long does shipping take for this product?' },
    // Context option chips (order)
    'chat.chip_ask_order': { id: '💬 Tanya pesanan ini', en: '💬 Ask about this order' },
    'chat.chip_ask_order_msg': { id: 'Halo, saya ingin bertanya terkait pesanan ini.', en: 'Hi, I\'d like to ask about this order.' },
    'chat.chip_when_ship': { id: '🚚 Kapan dikirim?', en: '🚚 When will it ship?' },
    'chat.chip_when_ship_msg': { id: 'Halo, kapan pesanan ini akan dikirim?', en: 'Hi, when will this order be shipped?' },
    'chat.chip_processed': { id: '⏳ Sudah diproses?', en: '⏳ Is it processed?' },
    'chat.chip_processed_msg': { id: 'Halo, apakah pesanan ini sudah diproses?', en: 'Hi, has this order been processed?' },
    'chat.chip_change': { id: '✏️ Ubah pesanan?', en: '✏️ Change order?' },
    'chat.chip_change_msg': { id: 'Halo, saya ingin mengubah pesanan ini. Apakah masih bisa?', en: 'Hi, I\'d like to change this order. Is that still possible?' },
    ...
    'order_detail.back': { id: 'Kembali ke Riwayat Pesanan', en: 'Back to Order History' },
    'order_detail.back_seller': { id: 'Kembali ke Orderan Masuk', en: 'Back to Incoming Orders' },
    'order_detail.status_waiting': { id: 'Menunggu Konfirmasi', en: 'Awaiting Confirmation' },
    'order_detail.status_processing': { id: 'Sedang Diproses', en: 'Being Processed' },
    'order_detail.status_shipped': { id: 'Sedang Dikirim', en: 'Being Shipped' },
    'order_detail.status_completed': { id: 'Pesanan Selesai', en: 'Order Completed' },
    'order_detail.status_cancelled': { id: 'Dibatalkan Pembeli', en: 'Cancelled by Buyer' },
    'order_detail.status_rejected': { id: 'Ditolak Keseluruhan', en: 'Fully Rejected' },
    'order_detail.shipping_info': { id: 'Informasi Pengiriman', en: 'Shipping Information' },
    'order_detail.recipient': { id: 'Penerima', en: 'Recipient' },
    'order_detail.phone': { id: 'Telepon', en: 'Phone' },
    'order_detail.address': { id: 'Alamat', en: 'Address' },
    'order_detail.shipping_address': { id: 'Alamat Pengiriman', en: 'Shipping Address' },
    'order_detail.payment': { id: 'Pembayaran', en: 'Payment' },
    'order_detail.payment_method': { id: 'Metode Pembayaran', en: 'Payment Method' },
    'order_detail.payment_status': { id: 'Status Pembayaran', en: 'Payment Status' },
    'order_detail.refunded': { id: 'Dana Dikembalikan', en: 'Refunded' },
    'order_detail.paid': { id: 'Lunas', en: 'Paid' },
    'order_detail.product_details': { id: 'Rincian Produk', en: 'Product Details' },
    'order_detail.item_rejected': { id: '⛔ Ditolak Penjual', en: '⛔ Rejected by Seller' },
    'order_detail.item_cancelled': { id: '❌ Dibatalkan', en: '❌ Cancelled' },
    'order_detail.item_shipped': { id: '🚚 Dalam Perjalanan Kurir', en: '🚚 In Transit' },
    'order_detail.item_received': { id: '✅ Barang Diterima', en: '✅ Item Received' },
    'order_detail.item_packing': { id: '🔵 Sedang Dikemas Penjual', en: '🔵 Being Packed by Seller' },
    'order_detail.item_waiting': { id: '🟡 Menunggu Lapak Diproses', en: '🟡 Waiting for Store to Process' },
    'order_detail.shipped_from': { id: 'Dikirim dari', en: 'Shipped from' },
    'order_detail.btn_received': { id: '✅ Diterima', en: '✅ Received' },
    'order_detail.done': { id: 'Selesai', en: 'Completed' },
    'order_detail.processing': { id: 'Diproses', en: 'Processing' },
    'order_detail.btn_cancel_item': { id: '❌ Batalkan', en: '❌ Cancel' },
    'order_detail.subtotal': { id: 'Subtotal Awal', en: 'Original Subtotal' },
    'order_detail.refund_label': { id: 'Barang Dibatalkan (Refund)', en: 'Cancelled Items (Refund)' },
    'order_detail.shipping_cost': { id: 'Ongkos Kirim', en: 'Shipping Cost' },
    'order_detail.free': { id: 'GRATIS', en: 'FREE' },
    'order_detail.total': { id: 'Total Bayar Akhir', en: 'Final Total' },
    'order_detail.btn_cancel_order': { id: 'Batalkan Pesanan', en: 'Cancel Order' },
    'order_detail.buyer_info': { id: 'Informasi Pembeli', en: 'Buyer Information' },
    'order_detail.buyer_name': { id: 'Nama Pembeli', en: 'Buyer Name' },
    'order_detail.recipient_at_address': { id: 'Penerima (di Alamat)', en: 'Recipient (at Address)' },
    'order_detail.product_ordered': { id: 'Produk Dipesan', en: 'Product Ordered' },
    'order_detail.unit_price': { id: 'Harga Satuan', en: 'Unit Price' },
    'order_detail.quantity': { id: 'Jumlah', en: 'Quantity' },
    'order_detail.total_revenue': { id: 'Total Pendapatan', en: 'Total Revenue' },
    'order_detail.btn_reject': { id: 'Tolak Pesanan', en: 'Reject Order' },
    'order_detail.btn_accept': { id: 'Terima/Proses', en: 'Accept/Process' },
    'order_detail.btn_ship': { id: 'Kirim Pesanan', en: 'Ship Order' },
    'order_detail.awaiting_buyer': { id: 'Sedang Dikirim... (Menunggu konfirmasi pembeli)', en: 'Being Shipped... (Awaiting buyer confirmation)' },
